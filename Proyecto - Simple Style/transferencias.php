...
LEFT JOIN clubes c1
ON t.club_origen = c1.nombre

LEFT JOIN clubes c2
ON t.club_destino = c2.nombre
...
<div class="transfer-card">
    ...
    <div class="transfer-top">
        ...
        <div class="transfer-info">
            ...
            <h2>
                <?= htmlspecialchars($t['jugador']) ?>
            </h2>

            <p class="position">
                <?= htmlspecialchars($t['posicion']) ?>
            </p>
    ...
    <div class="clubs">
        ...
        <div class="club">
            ...
            <span>
                ...
                <?= htmlspecialchars($t['club_origen_nombre']) ?>
        ...
        <div class="club">
            ...
            <span>
                ...
                <?= htmlspecialchars($t['club_destino_nombre']) ?>
    ...
    >
        ...
        <button
            ...
            onclick="return confirm('¿Seguro que quieres quitar esta transferencia?')"
